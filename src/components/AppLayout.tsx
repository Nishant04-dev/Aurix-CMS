...
const NAV_ITEMS = [
  ...
  { label: 'Projects',   icon: FolderKanban,     path: '/projects',          planFeature: null,                            roleAccess: null },
  { label: 'Tasks',      icon: CheckSquare,      path: '/tasks',             planFeature: null,                            roleAccess: null },
  ...
  { label: 'Files',      icon: FileText,         path: '/files',             planFeature: 'files' as FeatureKey,           roleAccess: null },
  ...
  { label: 'Team Chat',  icon: Hash,             path: '/org/chat',          planFeature: 'team_chat' as FeatureKey,       roleAccess: ['super_admin','admin','member'] },
