...
const NAV_ITEMS = [
  ...
  { label: 'Quotations', icon: FileText,          path: '/quotations',        perm: 'view_invoices', superAdminOnly: false, planFeature: null },
  ...
  { label: 'Roles',      icon: ShieldCheck,      path: '/roles',             perm: 'manage_roles',  superAdminOnly: false, planFeature: null },
